...
import { getResearchDay, isNewDayAvailable, isDormantPeriod } from './ist.js';
...
function testGetResearchDay() {
  ...
  // IST Date: 2026-04-21 00:00:00
  // In our mock, toZonedTime returns a Date shifted by 5:30.
  // So for t1 (12:00 UTC), toZonedTime returns 17:30 UTC.
  // getResearchDay then sets hours to 0, resulting in 2026-04-21 00:00:00 UTC.
  assert.strictEqual(d1.toISOString(), '2026-04-21T00:00:00.000Z');
  ...
  // Should be 2026-04-20 IST, which in mock is 2026-04-20 00:00 UTC
  assert.strictEqual(d2.toISOString(), '2026-04-20T00:00:00.000Z');

  // Exactly 06:00 IST (00:30 UTC)
  const t3 = new Date('2026-04-21T00:30:00Z');
  const d3 = getResearchDay(t3);
  // Should be 2026-04-21 IST, which in mock is 2026-04-21 00:00 UTC
  assert.strictEqual(d3.toISOString(), '2026-04-21T00:00:00.000Z');

  // 05:59:59 IST (00:29:59 UTC)
  const t4 = new Date('2026-04-21T00:29:59Z');
  const d4 = getResearchDay(t4);
  // Should be 2026-04-20 IST, which in mock is 2026-04-20 00:00 UTC
  assert.strictEqual(d4.toISOString(), '2026-04-20T00:00:00.000Z');
