      ...
      <div className="relative bg-black/70 backdrop-blur-sm px-4 py-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-4 md:gap-6">
            <Image src="https://assets.imace.online/image/ibmresearch.svg" alt="IBM Research" width={100} height={40} className="h-5 w-auto opacity-60 hover:opacity-100 transition" />
            <Image src="https://assets.imace.online/image/psycosys.svg" alt="PsyCoSys" width={100} height={40} className="h-5 w-auto opacity-60 hover:opacity-100 transition" />
            <Image src="https://assets.imace.online/image/altern.svg" alt="Altern" width={80} height={40} className="h-5 w-auto opacity-60 hover:opacity-100 transition" />
          </div>
        </div>
